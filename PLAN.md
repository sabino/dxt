...
- Generic tests: model column `unique`, `not_null`, default-quoted and explicit
  ...
  `quote: false` `accepted_values` are started; seed-attached column tests and
  wider generic-test config parity remain.
- Singular test.
