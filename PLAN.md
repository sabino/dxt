...
1. Selector parity for remaining `file:` edge cases, `ls --output-keys`, and
   wider selector/listing parity.
...
It does not implement `--output-keys`, metrics, semantic models, saved queries,
unit tests, or full dbt JSON object parity.
