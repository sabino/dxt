...
selected model/seed catalog node entries with relation metadata and ordered
columns when the selected relations already exist in the target DuckDB file.
It does not execute resources during docs generation, catalog sources,
