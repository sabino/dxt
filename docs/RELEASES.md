...
matrix with JUnit reports, and runs the public Jaffle parse/build/run gate with
a pinned, checksum-verified DuckDB CLI. Release jobs focus on portable binary
