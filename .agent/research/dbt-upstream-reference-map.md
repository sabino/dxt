...
- M2 implementation has started with narrow render-only compile/docs boundaries
  ...
  supported fixture subset. Broader parse-time Jinja context, macro namespace,
  adapter dispatch, materialization execution, catalog introspection, and
  run-results behavior remain future source-grounded slices.
